...
def main():
    ...
    #calculate dtw from train&test
    dtw_list = calc_dtw(train_list,test_list)
    print("your score: ",100*(1-dtw_list[-1][-1][0]))
    #make graph
    path = backward(dtw_list)
    plot_path(dtw_list,path,train_list,test_list)
